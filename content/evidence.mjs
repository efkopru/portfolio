...
export const featuredWork = [
  { id: 'utility-inspection-etl', role: 'Data engineering', image: 'assets/evidence/utility-inspection-pipeline.svg' },
  { id: 'accessibility-analysis', role: 'Data science', image: 'assets/evidence/accessibility-method.svg' },
  { id: 'interactive-maps-a-custom-js-app', role: 'Software engineering', image: 'assets/social/interactive-maps-a-custom-js-app.png' }
];
