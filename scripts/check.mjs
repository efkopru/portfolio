...
const allowed = new Set([...manifest.pages, ...siteProjects.flatMap(project => project.gallery.flatMap(image => [image.src, image.preview])), 'styles.css', 'script.js', 'theme.js', 'assets/efk-logo.avif', 'assets/gis-background.webp', 'sitemap.xml', 'robots.txt', '_headers', 'build-manifest.json']);
